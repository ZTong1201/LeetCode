...
public class generateParenthesis {
    ...
    private void backtrack(List<String> res, StringBuilder substring, int open, int close, int max) {
        ...
        if (open < max) {
            ...
            substring.append("(");
            backtrack(res, substring, open + 1, close, max);
        ...
        if (close < open) {
            ...
            substring.append(")");
            //并增加右括号数目
            backtrack(res, substring, open, close + 1, max);
