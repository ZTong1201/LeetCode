...
public class AddTwoNumbersII {
    ...
    public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        ...
        // the subsequent logic assumes len1 is always less than or equal to len2
        // hence, switch l1 and l2 if it violates the assumption
        ...
        // first skip extra nodes in l2 to make l1 and l2 have the same length
        ListNode head = null;
        for (int i = 0; i < len2 - len1; i++) {
            ListNode curr = new ListNode(l2.val);
            // always insert node at the front
            curr.next = head;
            head = curr;
            l2 = l2.next;
        }
        // then add values together without taking care of the carry value
        ...
        while (ptr != null) {
            ...
            ListNode curr = new ListNode((ptr.val + carry) % 10);
