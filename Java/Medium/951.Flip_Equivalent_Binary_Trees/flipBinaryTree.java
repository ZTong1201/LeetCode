...
public class flipBinaryTree {
    ...
    public boolean flipEquivRecursive(TreeNode root1, TreeNode root2) {
        // base 1: both trees are null - true
        if (root1 == null && root2 == null) return true;
        // base 2: only one of the trees is null - false
        if (root1 == null || root2 == null) return false;
        // base 3: if two root values are not the same - false
        if (root1.val != root2.val) return false;
        // there are two options at a given root node
        // 1. left1 == left2 && right1 == right2 meaning two subtrees are identical
        // 2. left1 = right2 && right1 = left2 meaning the subtrees will be identical after flipping
