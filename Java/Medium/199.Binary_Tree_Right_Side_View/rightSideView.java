...
public class rightSideView {
    ...
    public void rightSideViewTest() {
        ...
        List<Integer> actualDFS = rightSideViewDFS(tree);
        List<Integer> actualBFS = rightSideViewBFS(tree);
        assertEquals(expected.size(), actualDFS.size());
        assertEquals(expected.size(), actualBFS.size());
    }
